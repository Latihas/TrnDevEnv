...
//
// 	// public override List<ScriptUtils.TargetIcon> TargetIconList => [
...
// 		];
//
// 	// public override List<ScriptUtils.StartsCasting> StartsCastingList => [
...
// 		// new(new Regex("^.{14} Territory 01:(?!309)"), _ => {
// 		// 	RealPlugin.Instance.UnregisterNamedCallback(Info.ConfigName);
// 		// 	var vs = RealPlugin.Instance.GetVariableStore(false);
// 		// 	var rx = new Regex("tuw_.*");
...
// 		// 	vs.UnsetVariableRegex(vs.Table, rx);
// 		// 	vs.UnsetVariableRegex(vs.Dict, rx);
// 		// 	RealPlugin.Instance.sc.DeactivateRegex("tuw_", Triggernometry.UI.Scarborough.ItemAction.ItemTypeEnum.Text);
// 		// }),
...
// 		RealPlugin.Instance.RegisterNamedCallback(Info.ConfigName, new Action<object, string>((_, _) => Entry.Start()));
// 	}
//
...
// 		var hex火神Id = FindTargetHexIdByBnpcId("8730");
...
// 			configForm.AddPartyGroup(" 队员顺序保证和游戏内一致 ", new PartyListPanel(playerDescriptions));
//
// 			configForm.Run();
// 		}
//
...
// 		internal readonly List<string> dmg = []; //伤害
